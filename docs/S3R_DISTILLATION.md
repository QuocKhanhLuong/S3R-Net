...
- use `src/teachers/medsam2_teacher.py` for MedSAM2 prompt-driven field targets
...
See `docs/DUAL_TEACHER_KD.md` for the MedSAM2 + CineMA agreement-aware pipeline.
